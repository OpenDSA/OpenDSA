  ...
  var PIFrames = {
    ...
    Injector(data, av_name, skip_to, locations = {top: 10, left: 5}) {
      var obj = {
        ...
        // CAS: Turn off disabling the forward button, for classes where this
        // is not desirable to make people do the PI framesets for a grade.
        // It would be much better to make this a parameter to the exercise
        // at compile time, but I haven't figured that out yet.
        disableForwardButton: function() {
          return; // CAS: This is the change.
