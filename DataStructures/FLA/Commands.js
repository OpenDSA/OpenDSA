(function($) {
	...
	window.executeAddEdge = executeAddEdge;
	...
	window.executeMoveNode = executeMoveNode;
	...
	window.executeEditMealyNode = executeEditMealyNode;
	...
	window.executeEditMooreNode = executeEditMooreNode;
	...
	window.executeEditNode = executeEditNode;
	}(jQuery));