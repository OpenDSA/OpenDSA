...
(function() {
	...
	maxValue: function() {
	    ...
	    simple_demo_ex3.option[0] = my_array[1];
	    simple_demo_ex3.option[1] = my_array[2];
	    simple_demo_ex3.option[2] = my_array[3];
	    return my_array[0];
	},

    };

    window.simple_demo_ex3 = window.simple_demo_ex3 || simple_demo_ex3;
}());
