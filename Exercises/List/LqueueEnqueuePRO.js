...
(function() {
  ...
  var lqueueEnqueuePRO = {
    ...
    pclick: function(pointer) {
      ...
      status = 3;
      lqueueEnqueuePRO.userInput = true;
    },
    ...
    connect: function(obj1, obj2) {
      var i;
      if (obj1 === obj2) { return; }
      lqueueEnqueuePRO.connection(obj1, obj2);
      obj1.odsa_next = obj2;
      obj1._next = obj2;
    ...
    clickHandler: function(e) {
      ...
      if ((x > 31) && (x < 42) && (y > 0) && (y < 31)) {
        ...
        if (status === 2) {
          toNode = this;
          lqueueEnqueuePRO.connect(fromNode, toNode);
          $("#" + fromNode.id() + " .jsavpointerarea:first").removeClass("bgColor");
        ...
        $("#" + newLinkNode.id()).draggable({
          ...
          drag: function() {
            for (i = connections.length; i--; ) {
              lqueueEnqueuePRO.connection(connections[i].from, connections[i].to);
            }
