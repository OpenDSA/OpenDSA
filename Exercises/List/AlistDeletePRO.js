  ...
  var av, // The JSAV object
    ...
    alistDeletePRO = {
      ...
      initJSAV: function(arr_size, deletePos) {
        ...
        currArr = av.ds.array([delPosition], {
          left: 45,
          top: 90
        });
        currLabel = av.label("curr", {
          left: 10,
          top: 95
        });
        returnArr = av.ds.array(["null"], {
          left: 45,
          top: 125
        });
        returnLabel = av.label("return", {
          left: 0,
          top: 130
        });
        ...
        $("#reset").click(function() {
          alistDeletePRO.f_reset();
        });
      },

      // Check user's answer for correctness: User's array must match answer
      checkAnswer: function(arr_size) {
        if (delValue !== returnArr.value(0)) {
          return false;
        }
