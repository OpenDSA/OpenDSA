...
(function() {
	...
	initArr: function(arr_size) {
	    ...
	    var next_val;
	    var array_str;
	    my_array = ["True if the addition is successful, or false if not. ", "True if the bag contains anEntry, or false if not.", "The object that was added. ", "The values array filled with the entries in the bag."];
	    array_str = "";
