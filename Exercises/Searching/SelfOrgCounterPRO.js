...
(function() {
  "use strict";
    ...
    function clickHandler(e) {
      ...
      if(x > 31 && x < 42 && y > 0 && y < 31){
        ...
        SelfOrgCounterPro.userInput = true;
      }
    }
    ...
    function f_reset() {
      SelfOrgCounterPro.userInput = false;
      newNodeGen = false;
      connections = [];
      selected_node = null;
      status = 0;
  ...
  window.SelfOrgCounterPro = window.SelfOrgCounterPro || SelfOrgCounterPro;
}());