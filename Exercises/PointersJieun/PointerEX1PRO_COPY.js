...
(function() {
  ...
  var pointerEX1PRO = {
    ...
    clickHandler: function(e) {
      ...
      if ((x > 31) && (x < 42) && (y > 0) && (y < 31)) { // We are in the pointer part
        ...
        if (fromNode !== null) { // We are connecting another node to this node
          ...
          pointerEX1PRO.connect(fromNode, this, av);
          $("#" + fromNode.id() + " .jsavpointerarea:first").removeClass("bgColor");
          ...
          if (oldPointer.target() !== this) {
            selected_pointer = pointerEX1PRO.setPointer(selected_pointer.element.text(), this, oldPointer);
    ...
    reset: function() {
      ...
      // Create pointers
      pointerEX1PRO.setPointer("empRef", jsavList.get(0));
      pointerEX1PRO.setPointer("johnRef", jsavList.get(1));
      pointerEX1PRO.setPointer("samRef", jsavList.get(2));
      ...
      jsavList.click(pointerEX1PRO.clickHandler);
    },
