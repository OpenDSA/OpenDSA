...
(function() {
  ...
  function clickHandler(index) {
    ...
    pointerPRO.userInput = true;
  }

  // reset function definition
  function reset() {
    // Clear the old JSAV canvas.
    if ($("#GrowtRatesPRO")) { $("#PointerPRO").empty(); }

    // Set up the display
    av = new JSAV("PointerPRO");
  ...
  window.pointerPRO = window.pointerPRO || growthRatesPRO;
}());
