...
(function() {
    ...
    var cs342_uwosh_ex1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    cs342_uwosh_ex1.userInput = false;
	    av = new JSAV("Cs342_uwosh_ex1", {animationMode: "none"});
	...
	cs342_uwosh_ex1.userInput = true;
    }
    // Export name used here
    window.cs342_uwosh_ex1 = window.cs342_uwosh_ex1 || cs342_uwosh_ex1;
}());
