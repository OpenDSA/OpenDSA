...
(function() {
  ...
  function arrSwap (array, index1, index2) {
    ...
    function clickHandler(e) {
      ...
      if(x > 31 && x < 42 && y > 0 && y < 31){
        ...
        SelfOrgTransposePro.userInput = true;
      }
    }
    ...
    function f_reset() {
      SelfOrgTransposePro.userInput = false;
      newNodeGen = false;
      connections = [];
      selected_node = null;
      status = 0;
  ...
  window.SelfOrgTransposePro = window.SelfOrgTransposePro || SelfOrgTransposePro;
}());
