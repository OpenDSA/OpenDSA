...
(function() {
  "use strict";
	...
	init: function() {
	    ...
	    function evalExpRP23part2(exp,envir) {
		if (A.isIntExp(exp)) {
		    ...
		    var f = evalExpRP23part2(A.getAppExpFn(exp),envir);
		    var args = A.getAppExpArgs(exp)
			.map( function(arg) { 
			    return evalExpRP23part2(arg,envir); } );
		    if (E.isClo(f)) {
		...
		" expected but " + args.length + " given)");
			    ...
			    return evalExpRP23part2(E.getCloBody(f),
					   E.update(envir,
    ...
    window.RP23part2 = window.RP23part2 || RP23part2;
