  ...
  "use strict";
	...
	init: function() {
		...
		SL.printExp(
			...
			SL.absyn.generateRandomSLang1Program(0,2,5,"xyz","")));

	    while (expStr.length < 15 ||  expStr.length>50) {
		expStr = 
		    SL.printExp(
			SL.absyn.getProgramExp(
			    SL.absyn.generateRandomSLang1Program(0,2,5,"xyz","")));
	    ...
	    //console.log(exp);
	    //console.log("========================");
	    console.log(expStr.length);
	    this.expressions = expStr;
	    this.answer = "answer";
