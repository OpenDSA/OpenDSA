...
**Definition:** Given :math:`\Sigma`,
  ...
  #. :math:`r` is a R.E if and only if it can be derived from (1) with a finite number of applications of (2).
  |
...
|
Convert NFA with Multiple Final Stages to Single Final Stage
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. inlineav:: schematicRepCON ss
   :scripts: DataStructures/FLA/FA.js AV/WuChen/schematicRepCON.js
   :output: show
...
.. inlineav:: GTGtoNFACON ss
   :scripts: DataStructures/FLA/FA.js AV/WuChen/GTGtoNFACON.js
   :output: show
