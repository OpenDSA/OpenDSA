...
RegEx.
And we have seen corresponding grammars: Regular grammar, context-free 
grammars, etc.
...
the string; otherwise, it rejects the string.
...
This concept of converting is far more powerful than simply accepting.
