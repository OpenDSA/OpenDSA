...
.. inlineav:: primCON ss
   ...
   :links: AV/Ivan/primCON.css
   :scripts: AV/Ivan/primCON.js
   :output: show

.. avembed:: AV/Ivan/primAV.html ss
   :long_name: Prim's Algorithm Visualization
...
.. inlineav:: primPQCON ss
   :long_name: Prim's Minimum Cost Spanning Tree Algorithm (Priority Queue) Slideshow
   :links: AV/Ivan/primPQCON.css
   :scripts: AV/Ivan/primPQCON.js
   :output: show

.. avembed:: AV/Ivan/PrimPQAV.html ss
   :long_name: Prim's Algorithm (Priority Queue) Visualization
