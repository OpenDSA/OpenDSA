...
The diagram for the above transitions is:
   ...
   .. inlineav:: PDATransitionsExample dgm
      :links: AV/Lin/PDA/PDATransitionsExample.css
      :scripts: AV/Lin/PDA/PDATransitionsExample.js
      :align: center
...
.. topic:: Example
   ...
   .. inlineav:: PDAExample1 dgm
      :links: AV/Lin/PDA/PDAExample1.css
      :scripts: AV/Lin/PDA/PDAExample1.js
      :align: center
...
.. inlineav:: PDAAnBnTraceCON ss
   :links: DataStructures/FLA/FLA.css AV/Lin/PDA/PDAAnBnTraceCON.css
   :scripts: lib/underscore.js DataStructures/FLA/FA.js DataStructures/FLA/PDA.js AV/Lin/PDA/PDAAnBnTraceCON.js
   :output: show
...
.. topic:: Example
   ...
   .. inlineav:: PDASample dgm
      :links: AV/Lin/PDA/PDASample.css
      :scripts: AV/Lin/PDA/PDASample.js
      :align: center
...
.. topic:: Example
   ...
   .. inlineav:: PDAMMRsample dgm
      :links: AV/Lin/PDA/PDAMMRsample.css
      :scripts: AV/Lin/PDA/PDAMMRsample.js
      :align: center
...
.. topic:: Example
   ...
   Let us see the trace for accepting the string $aabbb$.

   .. inlineav:: PDADeterministic ss
      :links: DataStructures/FLA/FLA.css AV/Lin/PDA/PDADeterministic.css
      :scripts: lib/underscore.js DataStructures/FLA/FA.js DataStructures/FLA/PDA.js AV/Lin/PDA/PDADeterministic.js
      :align: show
...
.. topic:: Example
   ...
   Let us see the trace for accepting the string $aabbbc$.

   .. inlineav:: PDAProbDeterministic ss
      :links: DataStructures/FLA/FLA.css AV/Lin/PDA/PDAProbDeterministic.css
      :scripts: lib/underscore.js DataStructures/FLA/FA.js DataStructures/FLA/PDA.js AV/Lin/PDA/PDAProbDeterministic.js
      :align: show
...
.. topic:: Example
   ...
   Let us see the trace for accepting the string $aabbbb$.

   .. inlineav:: PDANonDeterministic ss
      :links: DataStructures/FLA/FLA.css AV/Lin/PDA/PDANonDeterministic.css
      :scripts: lib/underscore.js DataStructures/FLA/FA.js DataStructures/FLA/PDA.js AV/Lin/PDA/PDANonDeterministic.js
      :align: show
...
**Proof** (sketch)
   ...
   .. inlineav:: PDADiagram dgm
      :links: AV/Lin/PDA/PDADiagram.css
      :scripts: AV/Lin/PDA/PDADiagram.js
      :align: center
...
**Proof:**
   ...
   .. inlineav:: PDA2 dgm
      :links: AV/Lin/PDA/PDA2.css
      :scripts: AV/Lin/PDA/PDA2.js
      :align: center
