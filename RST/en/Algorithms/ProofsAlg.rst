...
.. extrtoolembed:: 'General induction proof template'
   :long_name: Dumbo7
   :learning_tool: code-workout-dev
   :workout_id: 96
   :frame_height: 1000
   :launch_url: https://codeworkoutdev.cs.vt.edu/gym/exercises/531/practice?workout_id=96
...
Now, check your understanding by reproducing this proof.

.. extrtoolembed:: 'Standard Simple Induction Proof Example'
   :long_name: Dumbo8
   :learning_tool: code-workout-dev
   :workout_id: 96
   :frame_height: 1200
   :launch_url: https://codeworkoutdev.cs.vt.edu/gym/exercises/532/practice?workout_id=97
