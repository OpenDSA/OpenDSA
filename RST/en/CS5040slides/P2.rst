...
.. slide:: Project 2 Design (1)
   ...
   |    All you need to do is implement the quadtree.
...
.. slide:: Project 2 Design (2)
   ...
   |    Quadtree (this is a class hierarch)
   |    Rectangle
   |    Rectangle list
...
.. slide:: Spatial Data Structures
   ...
   | Supporst spatial queries: Regionsearch, intersections
...
.. slide:: Rectangle Quadtree
   ...
   |    BUT: Can't ever split the rectangles if they all overlap
