...
.. avmetadata::
   :author: Cliff Shaffer, Alex Hicks
...
* You **must** use Eclipse IDE, and you **must** use it to submit to
  Web-CAT.
  You don't need to use Eclipse to write your code, but you do need to use it to submit to Web-CAT (and run mutation testing).

* There are  projects during the semester, each has a 4 week
  lifecyle.
