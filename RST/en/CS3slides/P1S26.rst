...
* We specify the class name for the project (SongsProj), an
  ...
  class that implements MovieRater (SongsDB).
...
* We give you the hash function to use.
...
* We give you some initial tests (SongsTest) that are meant to
  ...
  * Important service: We will check any tests added to SongsTest
...
* You should briefly skim Chapter 10 for now
  ...
  * Insertion is pretty standard.
    You will be hashing a string (song name or title).
