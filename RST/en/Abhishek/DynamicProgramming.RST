...
The cost of this algorithm (in terms of function calls) is the size of the n'th Fibonacci number itself, which our analysis of Module showed to be exponential (approximately 1.62n). 
