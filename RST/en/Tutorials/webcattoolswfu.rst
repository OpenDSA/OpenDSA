...
* Submission Definition URL: https://web-cat.cs.vt.edu/Web-CAT/WebObjects/Web-CAT.woa/wa/assignments/eclipse?institution=WFU

* Email: Your WFU email address (@wfu.edu).

* Username: Your WFU email address (@wfu.edu).
...
* In the ``Download URL`` field, enter the URL for your semester. So
  ...
  https://hicksa.sites.wfu.edu/assignments.xml
...
If you are using Web-CAT, then you probably will want to use the
...
You should now be able to use the local support for JUnit tests.
...
.. |stylefile| raw:: html
   ...
   <a href="https://hicksa.sites.wfu.edu/vtcsstylefixed.xml" target =
...
.. |checkstylefile| raw:: html
   ...
   <a href="https://hicksa.sites.wfu.edu/checkstyle.xml" target =
