...
.. TODO::
   ...
   Figure hashplot.gif - Hashing performance figure

The figure above shows how the expected number of record accesses grows as
:math:`\alpha` grows.
...
.. TODO::
   ...
   The following applet will let you examine the performace of various collision
   resolution methods as the load factor grows.
   First select a table size.
   Then examine the graphs generated by the applet.
