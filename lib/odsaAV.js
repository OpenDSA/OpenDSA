...
(function ($) {
  ...
  // Copied from odsaUtils.js to ensure AVs can operate independently of the OpenDSA framework
  /**
  ...
  // Ensure that URL parameters are parsed even if odsaUtils.js is not loaded
  if (!PARAMS) {
    window.PARAMS = {};
  ...
  $(document).ready(function () {
    ...
    $("body").on("jsav-log-event", function (e, data) {
      var flush = false,
          discardEvents = ["jsav-init", "jsav-recorded", "jsav-exercise-init", "jsav-exercise-model-init", "jsav-exercise-model-recorded"],
