...
(function ($) {
  ...
  function showProfCheckMark() {
    ...
    var check_mark_path;
    if (odsaUtils.loggingServerEnabled()) {
      check_mark_path = '/OpenDSA/khan-exercises/images/green_check.png';
    } else {
      check_mark_path = '/khan-exercises/images/green_check.png';
    }

    // show the green check_mark
    var check_mark = $("<span id='prof_check_mark'><img src='" + check_mark_path + "' alt='Proficient'></span>");
  ...
  function processEventData(data) {
    ...
    if (odsaUtils.ssEvents.indexOf(data.type) > -1) {
      ...
      data.desc.totalSteps = data.totalSteps; // was overwriting currentStep (copy-paste bug)
