...
(function ($) {
  ...
  function getConfig(url) {
    ...
    if (typeof configurationFile !== 'undefined') {
      if (configurationFile.hasOwnProperty('translations')) {
      ...
      console.error('JSON language file could not be loaded or is malformed. Please make sure your JSON is valid.');
    }
  ...
  /**
   * Reset the text of the exercise title, instructions label and instructions to the specified language
   */
  function setTitleAndInstructions(container, translation) {
  ...
  av.reset = reset;
  av.getConfig = getConfig;
  av.setTitleAndInstructions = setTitleAndInstructions;
  window.ODSA.AV = av;
