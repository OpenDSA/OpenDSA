  ...
  function sendEventData() {
    if (loggingServerEnabled()) {
      var tstamp = (new Date()).getTime(),
        ...
        userInteractions = {},
        eventObj;
      userInteractions['inst_book_id'] = ODSA.TP.instBookId;
      userInteractions['inst_section_id'] = ODSA.TP.instSectionId;
      userInteractions['inst_book_section_exercise_id'] = ODSA.TP.inst_book_section_exercise_id;
