...
(function ($) {
  ...
  function getBookID() {
    return (ODSA.includes('TP') && ODSA.TP.includes('instBookId')) ? ODSA.TP.instBookId : null;
  }
  ...
  function getChapterID() {
    return (ODSA.includes('TP') && ODSA.TP.includes('instChapterId')) ? ODSA.TP.instChapterId : null;
  }
    ...
    if (ODSA.TP) {
      ...
      if (getGlossaryInfoSuccess && json_data) {
        ...
        if (!json_data["module_map"]["Glossary"]) {
          ...
          canvasGlossaryPageLink = "https://canvas.instructure.com/courses/" + canvasID + "/modules/items/" + glossaryPageID;
        }
      }
      else {
        getGlossaryInfoSuccess = false;
