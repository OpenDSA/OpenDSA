...
(function () {
  ...
  */
  ...
  function getCurrentPageName(chapterName, moduleName) {
    ...
    chapterName = chapterName.toLowerCase().replaceAll(" ", '_').replaceAll("-", "")
    moduleName = moduleName.toLowerCase().replaceAll(" ", '_').replaceAll("-", "");
