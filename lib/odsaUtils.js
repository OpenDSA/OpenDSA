...
(function($) {
  ...
  function loadLangMod() {
    var langText = {},
      ...
      url = 'OpenDSA/_static/language_msg.json';
  ...
  function getBookID() {
    if (typeof ODSA.SETTINGS.BOOK_ID === "undefined") {
      ...
      ODSA.SETTINGS.BOOK_ID = ODSA.TP.toParams.launch_params.custom_canvas_course_id;
    }
  ...
  function loadConfig(args) {
    ...
    $.ajax({
      // Provide a complete absolute path in order for sinatra to correclty locate and return a resource.
      url: json_url + av_name + ".json",
