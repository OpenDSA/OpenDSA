...
(function ($) {
  ...
  function loadConfig(args) {
    ...
    var result = {
      ...
      code: undefined,
      getSettings: function () { return new JSAV.utils.Settings($(".jsavsettings")); },
      params: {}
    };
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (code_lang !== 'none' && typeof configurationFile !== 'undefined' && configurationFile.hasOwnProperty('code')) {
          ...
          // Save a list of all the code languages in the configuration file
          code_langs = Object.keys(configurationFile.code);
