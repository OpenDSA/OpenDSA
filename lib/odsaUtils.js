...
(function ($) {
  ...
  function getBookID() {
    ...
    // Parses the base URL for the book, eliminates the protocol so that the book is considered the same regardless of using HTTP or HTTPS
    loc = loc.substring(loc.indexOf(':') + 3, loc.lastIndexOf('/') + 1);
