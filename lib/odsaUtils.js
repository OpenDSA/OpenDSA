...
(function ($) {
  ...
  function loadLangData(args) {
    ...
    // Assume the JS file with the AV code has the same name as the AV (convention for standalone AVs)
    var js_filename = av_name;

    // Assume the name of the json file is the same as the name of the AV (convention for standalone AVs)
    ...
    // Append '.json' to the end of the url, if it doesn't already exist
