...
/**
 * IMPORTANT: jquery.transit is obsolete and needs to be replaced.
 * In the meantime, this has been hacked to make things seem to work.

 * See HACK comments below.
 */
...
(function($) {
  ...
  function getProperties(props) {
    ...
    $.each(props, function(key) {
      // START HACK: Remove changes to key values, since we never seem
      // to need them, and the use of camelCase is deprecated.
      // Beyond that, there seems to be a problem with the property
      // table hashmap as well.
      console.log("Key to process that we are passing through: ", key);
  ...
  function registerCssHook(prop, isPixels) {
    ...
    // jQuery 4.0 removed $.cssNumber and no longer appends 'px' to unknown properties.
    if (!isPixels && $.cssNumber) { $.cssNumber[prop] = true; }
