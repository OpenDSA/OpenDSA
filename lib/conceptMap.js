...
//                    {   
//                            for (var i=0; i<=d.parent.edges.lenght; i++)
//                            {
//                                if(d.data.id == d.parent.edges[i].data.id)
//                                {
//                                    
//                                if (d.parent.x >= width/2-100 && d.parent.x <= width/2+100 && d.parent.y >= height/2 -100 && d.parent.y <= height/2 +100 )
//                                    angle = (count / (d.parent.edges.length)) * 2 * Math.PI;
//                                if (d.parent.x >= width/2+100 && d.parent.y <= height/2 -100)
//                                    angle = (count / (d.parent.edges.length)) *  Math.PI /2;
//                                if (d.parent.x >= width/2+100 && d.parent.y >= height/2 +100)
//                                    angle = (count / (d.parent.edges.length)) *  Math.PI / 2 + Math.PI*3/2;
//                                if (d.parent.x <= width/2-100 && d.parent.y <= height/2 -100)
//                                    angle = (count / (d.parent.edges.length)) *  Math.PI / 2 + Math.PI / 2;
//                                if (d.parent.x <= width/2-100 && d.parent.y >= height/2 +100)
//                                    angle = (count / (d.parent.edges.length)) *  Math.PI / 2 + Math.PI;
//                                    d.x = (200* Math.cos(angle)) + d.parent.x + d.parent.width /2;
//                                    d.y =  (220*Math.sin(angle)) + d.parent.y + d.parent.height /2;
//                                    d.fixed;
//                                    count = count + 1;
//                                    if(count == (d.parent.edges.length))
//                                        count =0;
//                                    }
//                                    break;
//                            }
...
//                    }
                        ...
                        
                    {
                        ...
                        //d.x = d.x + Math.max(5, Math.min(width - 2, d.x));
                        //d.y = d.y + Math.max(5, Math.min(height - 2, d.y));
    ...
    function drag_end(d) {
        if (!d3.event.active) simulation.alphaTarget(0);
          ...
          //d.x = d.x > 800 ? 800 : d.x < 70 ? 70 :  d3.event.x;
          //d.y = d.y > 600 ? 600 : d.y < 10 ? 10 :  d3.event.y;     
    }
