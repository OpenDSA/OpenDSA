...
var CMap = (function(){
    ...
    function printGraph(concept) {
        ...
        circles.attr("rx", function(d, i){
                    return Math.sqrt(2)*(d.width/2);
                })
        circles.attr("ry", function(d, i){
                    return Math.sqrt(2)*(d.height/2);
                })
        ...
        forceGraph.on("tick", function() {
            ...
            nodes.attr("transform", function(d){
                ...
                d.x = d.x - d.radius < 0 ? d.x+= 1 : d.x = d.x;
                d.x = d.x + d.radius > width ? d.x -= 1: d.x = d.x;
                d.y = d.y - d.radius < 0 ? d.y+= 1 : d.y = d.y;
                d.y = d.y + d.radius > width ? d.y -= 1: d.y = d.y;
