...
(function(){
  ...
  typeof window.serverOverride !== "undefined"? serverOverride : {};
 
  var khanVersion = "new";

  if(khanVersion === "old"){
    urlBaseOverride = "../../ODSAkhan-exercises/";
    var url = "../../lib/khan-exercise.js";
    ...
    urlBaseOverride = "../../khan-exercises/";
    var url = "../../khan-exercises/khan-exercise.js";
  }
  loadScript(url);
