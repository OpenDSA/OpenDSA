...
(function() {
      ...
      jQuery.ajax({
        ...
        success: function(data) {
          if (Khan.odsaGetCurrentExercise) {
            ...
            Khan.studentData.correct_exercises = data.objects[0].correct_exercises.split(',') || undefined;
  ...
  Khan.odsaLoadExercises = function() {
    $(function() {
      ...
      console.log("inside odsaLoadExercises");
  ...
  Khan.saveAttemptToServer = function(url, attemptData) {
    ...
    promise.done(function(data) {
      ...
      Khan.studentData.correct_exercises = data.correct_exercises.split(',') || undefined;
