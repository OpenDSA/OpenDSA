  ...
  Khan.loadModule = function (moduleName, exerciseId) {
    ...
    if (moduleName === 'jsav' || jsavExtensions.indexOf(moduleName) > -1) {
      require([
        ...
        "../../lib/d3.v7.min.js"
      ], function (transit, d3lib) {
        // RequireJS is present, so d3's UMD wrapper registers as an AMD module
        // instead of assigning the global that JSAV expects. Expose it manually.
        if (typeof window.d3 === "undefined" && d3lib) {
          window.d3 = d3lib;
        }
        require(["jsav"],
          function () {
...
/*     if (typeof SPLICE !== 'undefined' && SPLICE.reportScoreAndState && SPLICE.sendEvent) {
      var exerciseName = data.problem_type ? data.problem_type : 'unknown';
      SPLICE.reportScoreAndState(exerciseName, data.complete, data);
      SPLICE.sendEvent(exerciseName, 'attemptData', data);
    } else {
