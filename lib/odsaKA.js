...
(function() {
  ...
  Khan.loadModule = function(moduleName, exerciseId) {
    ...
    var jsavExtentions = ["ArrayTree", "AVLextension", "binaryheap", "CircularQueue", "DoubleLinkList", "huffman", "redblacktree"];
    var jsavExPath = "../../DataStructures/";
    var modulePromises = {};
    ...
    if (moduleName === 'codemirror') {
      ...
      if (moduleName === 'ArrayTree') {
        require([jsavExPath + "ArrayTree.js"],
          function() {
            loadCss(jsavExPath + "ArrayTree.css");
          });
      } else if (moduleName === 'AVLextension') {
        require([jsavExPath + "AVLextension.js"]);
      } else if (moduleName === 'binaryheap') {
        require([jsavExPath + "binaryheap.js"]);
      } else if (moduleName === 'CircularQueue') {
        require([jsavExPath + "CircularQueue.js"]);
      } else if (moduleName === 'DoubleLinkList') {
        require([jsavExPath + "DoubleLinkList.js"],
          function() {
            loadCss(jsavExPath + "DoubleLinkList.css");
          });
      } else if (moduleName === 'huffman') {
        require(["../../DataStructures/huffman.js"],
          function() {
            loadCss(jsavExPath + "huffman.css");
          });
      } else if (moduleName === 'redblacktree') {
        require(["../../DataStructures/redblacktree.js"]);
      }
