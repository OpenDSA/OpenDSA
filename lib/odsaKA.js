...
(function() {
  ...
  Khan.loadSummExercise = function(exerciseId, fileName) {
    ...
    $.get(Khan.odsaExerciesPath + fileName).done(function(data) {
      ...
      // if ($(newContents).is(':empty')) {
      //   console.log("newContents is not empty");
      // }
      // console.dir($body.find(".exercise"));
      // promise.resolve();
  ...
  Khan.odsaLoadExercises = function() {
    $(function() {
      ...
      // TODO: here you should load Summ exercises recursively
      ...
      $.when.apply($, summPromises).then(function() {
        console.log("inside when.apply");
        var $body = $('body');
        console.dir($body.find(".exercise"));
