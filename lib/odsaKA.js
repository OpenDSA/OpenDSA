...
(function() {
      ...
      jQuery.ajax({
        ...
        success: function(data) {
          if (Khan.odsaGetCurrentExercise) {
            Khan.studentData.currentExercise = data.objects[0].current_exercise || undefined;
            Khan.studentData.hintedExercise = data.objects[0].hinted_exercise || undefined;
            Khan.studentData.correctExercises = data.objects[0].correct_exercises || undefined;
            if (Khan.studentData.correctExercises) {
              Khan.studentData.correctExercises = Khan.studentData.correctExercises.split(',');
            }
  ...
  Khan.saveAttemptToServer = function(url, attemptData) {
    ...
    promise.done(function(data) {
      ...
      Khan.studentData.currentExercise = data.current_exercise || undefined;
      Khan.studentData.hintedExercise = data.hinted_exercise || undefined;
      Khan.studentData.correctExercises = data.correct_exercises || undefined;
      if (Khan.studentData.correctExercises) {
        Khan.studentData.correctExercises = Khan.studentData.correctExercises.split(',') || undefined;
      }
