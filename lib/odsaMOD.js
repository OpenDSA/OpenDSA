  ...
  function initExercises(elem) {
    ...
    if ($elem.attr('data-oembed') === 'true') {
      ...
      var width = $elem.attr("data-frame-width"),
        ...
        src = $elem.attr("data-frame-src") + separator + 'scoringServerEnabled=' + odsaUtils.scoringServerEnabled() + '&threshold=' + threshold + '&points=' + points + '&required=' + required + '&workoutId=' + workoutId;
