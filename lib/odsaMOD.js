    ...
    eventer(messageEvent, function (e) {
      ...
      if (data) {
        if (data.type === "resize-iframe") {
          ...
          console.log(data.time + " Received form KA exercise: " + data.exerciseName + " callCount: " + data.callCount);
          ...
          console.log(data.time + " Received form AV exercise: " + data.exerciseName + " callCount: " + data.callCount);
          // console.log(data.exerciseName + " data.exerciseName received form KA iframe");
          var sectionId = $('#' + data.exerciseName + '_iframe').parents('.section').first().attr('id')
          if (data.callCount > 0) {
            TimeMe.addTimeOnElementInSeconds(sectionId, data.time);
