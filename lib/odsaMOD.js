...
(function($) {
  ...
  function loadModule(modName) {
    ...
    if (odsaUtils.scoringServerEnabled()) {
      if (odsaUtils.isFullModule()) {
        ...
        url = "/odsa_exercise_progresses?inst_module_version_id=" + odsaUtils.getInstModuleVersionID();
      }
      else {
  ...
  function initExercises(elem) {
    ...
    if ($elem.attr('data-oembed') === 'true') {
      ...
      $(iFrameSelector).replaceWith('<iframe id="' + exerName + '_iframe" src="' + src + '" class="embeddedExercise" width="' + width + '" height="' + height + '" data-showhide="' + showhide + '">Your browser does not support iframes.</iframe>');
