...
(function ($) {
  ...
  const sendScoreData = (data) => {
    ...
    let scoreData = data.state.isKA ? data.state : handlePE(data)

    let url = data.state.isKA ? "/odsa_exercise_attempts/new/ka" 
                              : "/odsa_exercise_attempts/new/pe";
