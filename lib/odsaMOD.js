...
(function($) {
  ...
  $(document).ready(function() {
    ...
    odsaUtils.logUserAction('document-ready', 'User loaded the ' + ODSA.TP.sectionTitle + ' section page');
    ...
    if (odsaUtils.scoringServerEnabled()) {
      ...
      $(window).focus(function(e) {
        ...
        odsaUtils.logUserAction('window-focus', 'User looking at ' + ODSA.TP.sectionTitle + ' section');
      });

      $(window).blur(function(e) {
        // When the user leaves an OpenDSA window, log it
        odsaUtils.logUserAction('window-blur', 'User is no longer looking at ' + ODSA.TP.sectionTitle + ' section');
      });

      $(window).on('beforeunload', function() {
        // Log the browser unload event
        odsaUtils.logUserAction('window-unload', 'User closed or refreshed ' + ODSA.TP.sectionTitle + ' section');
      });
