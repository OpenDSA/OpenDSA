...
(function($) {
  ...
  function loadModule(modName) {
    ...
    if (odsaUtils.scoringServerEnabled()) {
      jQuery.ajax({
        url: "/odsa_exercise_progresses/" + ODSA.TP.instBookId + "/" + ODSA.TP.instSectionId,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        xhrFields: {
        ...
        success: function(data) {
          ...
          for (var exerName in data['proficient_exercises']) {
            if (data.hasOwnProperty('proficient_exercises')) {
