  ...
  function initExercises(elem) {
    ...
    if ($elem.attr('data-oembed') === 'true') {
      ...
      var width = $elem.attr("data-frame-width"),
        ...
        src = $elem.attr("data-frame-src") + '&scoringServerEnabled=' + odsaUtils.scoringServerEnabled() + '&threshold=' + threshold + '&points=' + points + '&required=' + required;

      if (odsaUtils.scoringServerEnabled()) {
        src = src + '&instBookId=' + odsaUtils.getBookID() + '&instSectionId=' + odsaUtils.getSectionID()
      };
