  ...
  $(document).ready(function () {
    ...
    eventer(messageEvent, function (e) {
      ...
      if (data && data.type === "resize-iframe") {
        ...
        // IMPORTANT: Since the workaround for the issue where Firefox won't properly load the CSS of an iFrame embedded page if its hidden requires the iframe to have a height and width of zero, if we resize it, we have to hide it
