...
function sweep(av, arr, incr, interpret) {
  ...
  av.step();
  var highlightFunction = function(index) {
    return index % incr === j;
  };
...
function showDifference(av_name, theArray, a) {
  ...
  var origarr = av.ds.array(theArray, {
    indexed: true
  });
  var origlabel = av.label(interpret("av_diff1"), {
    before: origarr
  });
  var arr = av.ds.array(a, {
    indexed: true
  });
  var arrlabel = av.label(interpret("av_diff2"), {
    before: arr
  });
