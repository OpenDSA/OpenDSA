...
$(document).ready(function() {
  ...
  var av = new JSAV(av_name);
   ...
   labParticipation.hide();
   labConstraint.hide();
   var labCardDefTitle=av.label("<span style='color:blue;'> Participation </span>", {left:LabelLeft, top: labelTop});
   labCardDefTitle.css({"font-weight": "bold", "font-size": 22});
   av.step();

   //slide 5
   var labCardDef1=av.label("It tells us whether the relationship is <span style='color:green;'>important</span> or <span style='color:green;'>not</span> ?", {left:LabelLeft, top: labelTop+40});
   labCardDef1.css({"font-weight": "bold", "font-size": 20});
   av.step();

   //slide 6
   var labCardDef2=av.label("identifies if all instances of an entity should <span style='color:green;'> participate in the relationship or not</span>.", {left:LabelLeft, top: labelTop+80});
   labCardDef2.css({"font-weight": "bold", "font-size": 20});
   av.step();

   //slide 7
   var labCardDef3=av.label("determines <span style='color:green;'> minimum number </span> of times an instance of one entity can be associated with an instance in the related entity.", {left:LabelLeft, top: labelTop+120});
   labCardDef3.css({"font-weight": "bold", "font-size": 20});
   av.step();

   //slide 8
   var labCardType=av.label("<span style='color:blue;'> Participation Types </span>", {left:LabelLeft, top: labelTop+200});
   labCardType.css({"font-weight": "bold", "font-size": 22});
   av.step();

   //slide 9
   var labCarType1=av.label("<span style='color:green;'>[Optional]</span>", {left:LabelLeft, top: labelTop+260});
   labCarType1.css({"font-weight": "bold", "font-size": 20});
   av.step();

   //slide 10
   var labCarType2=av.label("<span style='color:green;'>[Mandatory]</span>", {left:LabelLeft, top: labelTop+360});
