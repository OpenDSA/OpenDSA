...
$(document).ready(function() {
  "use strict";
  var av_name = "One-to-oneBinarySol2";
  ...
  var themMatrix3 = [["con-name","area","Population","Language"],["Egypt","102m.Km^2","100million","Arabic"],["USA","9.83m.Km^2","307million","English"],["UK","242,000Km^2","65million","English"]];
  ...
  conSchlab.hide();
  var conSchema = [["con-name","con-area","Population","Language"]];
  ...
  capSchlab.hide();
  var capSchema = [["Cap-name","Cap-area","Cap-population","con-id(FK)"]];
  ...
  var themMatrix2 =[["Cap-name","area","population","con-id(FK)"],["London","1572km^2","8.4million",""],["Washington","184827km^2","681million",""],["cairo","3085km^2","21million",""]];
  var matrx2= av.ds.matrix(themMatrix2, {style: "table", top: arrayTop, left: arrayLeft });

  var themMatrix2Copy =[["Cap-name","area","population","con-id(FK)"],["London","1572km^2","8.4million",""],["Washington","184827km^2","681million",""],["cairo","3085km^2","21million",""]];
 ...
 // var matrix5Flag=0;
  ...
  ellipse.hide();
  //line 1 is the line coming out of table country without arrow end its x1 & y1 is inside country entity and x2 & y2 going out above country entity
  var line1 = av.g.line(0,0, 0,  0, { opacity: 100, "stroke-width": 2});
  line1.hide();
  //line 7 is the line coming out of the area between table country and table capital its x1 & y1 are equal to x2 & y2 of line 1 while its x2 & y2 goes capital entity
  var line7 = av.g.line(0,0, 0,  0, {"arrow-end": "classic-wide-long", opacity: 100, "stroke-width": 2});
  line1.hide();
  var line7x1=x2;  //where x2 is the coordinate of line1
  var line7y1=y2;  //where y2 is the coordinate of line1
  var line7x2=0;
  var line7y2=0;
  ...
  y2=arrayTop+(30*((capNo)+1))-40;
  cy=arrayTop+(30*((conNo)+1));
  line7x2=arrayLeft+(80*4);  //where 80 is the width of the cell in capital matrix and 4 is the  number of the last cell
  line7y2=arrayTop+(30*((capNo)+1))-10;
  elRX=35;
  elRy=15;
  ellipse=av.g.ellipse(cx,cy ,elRX ,elRy, {stroke: "red","stroke-width": 2});
  line1.movePoints([[0, x1, y1], [1, x2, y2]]);
  line1.show();
  line7.movePoints([[0, line7x1, line7y1], [1, line7x2, line7y2]]);
  line7.show();
  matrx2._arrays[capNo].highlight(3);
  av.step();
  ...
  line1.hide();
  line7.hide();
  matrx2._arrays[capNo].unhighlight(3);
  conNo=1;
  capNo=3;
  //NoEmpProB++;
  y1=arrayTop+(30*((conNo)+1));
  ...
  ellipse.hide();
  line1.movePoints([[0, x1, y1], [1, x2, y2]]);
  matrx1._arrays[conNo].highlight(0);
  matrx1._arrays[conNo].highlight(1);
  matrx1._arrays[conNo].highlight(2);
  matrx1._arrays[conNo].highlight(3);
  matrx2._arrays[capNo].highlight(0);
  matrx2._arrays[capNo].highlight(1);
  matrx2._arrays[capNo].highlight(2);
  ...
  line7.show();
  matrx2._arrays[capNo].highlight(3);
  matrx2._arrays[capNo].value(3,"Egypt");
  av.step();
 ...
 line1.hide();
 line7.hide();
 matrx1._arrays[conNo].unhighlight(0);
  matrx1._arrays[conNo].unhighlight(1);
  matrx1._arrays[conNo].unhighlight(2);
  matrx1._arrays[conNo].unhighlight(3);
  matrx2._arrays[capNo].unhighlight(0);
  matrx2._arrays[capNo].unhighlight(1);
  matrx2._arrays[capNo].unhighlight(2);
 matrx2._arrays[capNo].unhighlight(3);
 conNo=3;
 capNo=1;
 //NoEmpProB++;
 ...
 line7.show();
 matrx2._arrays[capNo].highlight(3);
 matrx2._arrays[capNo].value(3,"UK");
av.step();
 ...
 line7.show();
 matrx2._arrays[capNo].highlight(3);
 matrx2._arrays[capNo].value(3,"USA");
 av.step();
 ...
 // mainline2X2+=90;
  ...
  line5.show();
  //vertical line beside table country
  line6.movePoints([[0,mainline2X1-250,mainline2Y1-10], [1,mainline2X1-250 ,mainline2Y1+10]]);
  line6.show(); 
  var lab2=av.label(interpret("<span style='color:red;'> Has </span>"), {left: ((mainline2X1-mainline2X2)+220), top: mainline2Y1- 50 });
