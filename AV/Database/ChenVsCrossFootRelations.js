...
$(document).ready(function() {
  ...
  var av = new JSAV(av_name);
   ...
   var labCardinality=av.label("Assume having <span style='color:blue;'> Employee </span> entity & <span style='color:blue;'> Employee </span>", {left: LabelLeft+NotationHorGaps*colNo, top: labelTop });
