...
$(document).ready(function() {
  "use strict";
  var av_name = "ChenVsCrossFootRelationsM1";
  ...
  var av = new JSAV(av_name);
   ...
   var labCardinality=av.label("Here all <span style='color:blue;'> Many-to-one </span> relationship combinations with <span style='color:blue;'> all participation alternatives </span>", {left: LabelLeft+100, top: labelTop });
  ...
  var LabRSym=av.label(interpret("(opt) <span style='color:green;'> many-to-one</span> (man) "), {left: LabelLeft-50, top: pY-50 });
  ...
  var otolabR=av.label("<span style='color:blue;'> M </span>", {left: pX+10-20-90, top:pY-40 });
  av.step();
 ...
 // CrowsoneLft.show();
  ...
  //slide 6
  av.umsg("Here is the chen's relation symbol".bold().big());
  var LabRSym2=av.label(interpret("(opt) <span style='color:green;'> many-to-one</span> (opt) "), {left: LabelLeft-50, top: pY+60 });
 ...
 // otochenRht22.show();
  ...
  var otolabR2=av.label("<span style='color:blue;'> M </span>", {left: pX+10-20-90, top:pY+70 });
  av.step();
 ...
 // CrowsoneRyt1.show();
  ...
  //slide 9
  av.umsg("Here is the chen's relation symbol".bold().big());
  var LabRSym3=av.label(interpret("(man) <span style='color:green;'> many-to-one</span> (man)"), {left: LabelLeft-50, top: pY+170 });
  ...
  var otolabR3=av.label("<span style='color:blue;'> M </span>", {left: pX+10-20-90, top:pY+180 });
  av.step();
...
//  CrowsoneLft31.show();
  ...
  //slide 12
  av.umsg("Here is the chen's relation symbol".bold().big());
  var LabRSym4=av.label(interpret("(man) <span style='color:green;'> many-to-one</span> (opt)"), {left: LabelLeft-50, top: pY+280 });
 ...
 // otochenRht42.show();
  ...
  var otolabR4=av.label("<span style='color:blue;'> M </span>", {left: pX+10-20-90, top:pY+290 });
  av.step();
