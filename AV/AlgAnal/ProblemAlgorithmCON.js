...
$(document).ready(function() {
  ...
  var labelProblem = av.label("Searching Problem", {top: topAlign + 25, left: leftAlign + 391});
  av.step();
  ...
  var labelInput = av.label("Target key", {top: topAlign + 92, left: leftAlign + 215}).css({"font-size": "18px", "text-align": "center", "font-style": "bold"});
  ...
  var labelOutput1 = av.label("Found", {top: topAlign + 14, left: leftAlign + 386 + rectWidth});
  var labelOutput2 = av.label("Not found", {top: topAlign + 104, left: leftAlign + 385 + rectWidth});
  var labelOutput3 = av.label("Index of the target key", {top: topAlign + 23, left: leftAlign + 490 + rectWidth});
  ...
  // Slide 7
  av.umsg(interpret("av_c7"), {preserve: true});
  var count = 0;
  while (count < 6) {
  ...
  labelInput = av.label("Target key = " + arr_values[3],
                        {top: topAlign + 92, left: leftAlign + 180}).css({"font-size": "18px", "text-align": "center", "font-style": "bold"});
  labelOutput2.hide();
  labelOutput4.hide();
  lineOutput2.hide();
  ...
  labelProblem.css({top: "-=45", left: "+=20"});
  labelOutput1.hide();
  labelOutput3.hide();
  lineOutput1.hide();
  arr.hide();
  ...
  // Slide 9
  av.umsg(interpret("av_c9"), {preserve: true});
  arr.show();
  line1.show();
  line2.show();
  labelInput.show();
  ...
  // Slide 12
  av.umsg(interpret("av_c12"), {preserve: true});
  pseudo.show();
  ...
  // Slide 14
  av.umsg(interpret("av_c14"), {preserve: true});
  labelInput.show();
  line1.show();
  line2.show();
  arr.show();
  ...
  // Slide 15
  av.umsg(interpret("av_c15"), {preserve: true});
  av.step();
