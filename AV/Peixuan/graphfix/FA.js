...
(function ($) {
  ...
  function addLayoutListeners(av, node) {
    if(!nodeChangedAutomaton.includes(node.automaton)){
      ...
      //console.log(node.automaton);
      $("#" + av.container[0].id + " .jsavbegin").click(function() {
          //debugger;
          //console.log("jsavbegin", av._undo, av._redo);
          node.automaton.layout();
          //console.log("layout", av._undo, av._redo);
          restoreAnimStacks(av);
          //console.log("restoreAnimStacks", av._undo, av._redo);
      })
      ...
      $("#" + av.container[0].id + " .jsavend").click(function() {
          ...
          //console.log("layout", av._undo, av._redo);
          restoreAnimStacks(av);
          //console.log("restoreAnimStacks", animStacks, av._undo, av._redo);
      })
    }
  }
