...
$(document).ready(function() {
    ...
    pseudo1.removeClass([7,8], "blue");
    pseudo1.removeClass([9,10], "red");
    pseudo1.addClass([11,12,13], "blue");
    pseudo1.addClass([14,15], "red");
    ...
    pseudo1.removeClass([11,12,13], "blue");
