...
(function ($) {
    ...
    //////////////////////////////////////////////////////////////////
    // Get the parse produced by JISON and assign to parseTree3_grammar
    /////////////////////////////////////////////////////////////////
    ...
    */
	...
	var the_parse_tree;
	try {
	    the_parse_tree = parseTree3_grammar.parse(the_exp);
	    ...
	    arr = e.message.split("\n");
	    var label_arr = [];
	    // More informative if we display it on multiple-lines
	    for (i = 0; i < arr.length; i++) {
		label_arr.push(av.label(arr[i]));
		label_arr[i].addClass("err_message"); // Ensures carrot points to guilty character
	    }
	    av.step();
	    av.displayInit();
	    av.recorded();
