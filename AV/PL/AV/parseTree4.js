...
$(document).ready(function () {
    ...
    //////////////////////////////////////////////////////////////////
    // Get the parser produced by JISON and assign to parseTree3_grammar
    // Through the closing comment "End of parser", this is automatically
    // generated code and should not be altered.
    /////////////////////////////////////////////////////////////////
    ...
    */
    var parseTree4_grammar = (function(){
	...
	var parser = {trace: function trace() { },
		      ...
		      table: [{3:1,4:2,6:3,11:$V0,12:$V1},{1:[3]},{5:[1,6],7:$V2,8:$V3,9:$V4,10:$V5},o($V6,[2,2]),o($V6,[2,7]),{4:11,6:3,11:$V0,12:$V1},{1:[2,1]},{6:12,11:$V0,12:$V1},{6:13,11:$V0,12:$V1},{6:14,11:$V0,12:$V1},{6:15,11:$V0,12:$V1},{7:$V2,8:$V3,9:$V4,10:$V5,13:[1,16]},o($V6,[2,3]),o($V6,[2,4]),o($V6,[2,5]),o($V6,[2,6]),o($V6,[2,8])],
    ...
    // End of parser
    // Code after this does the actual AV

    //////////////////////////////// parseTree4_grammar now has the parser
    ...
    // Use this instatiation for embedding in standalone html file
    //        av = new JSAV($("#parseTree"));
    //////////////////////////////////////////////////////

    // Use this instantiation for embedding in RST file
    var av_name = "parseTree4";
    ...
    var the_parse_tree = parseTree4_grammar.parse(the_exp);
