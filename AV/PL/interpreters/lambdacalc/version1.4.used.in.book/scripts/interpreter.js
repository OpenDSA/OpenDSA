...
function interpret(av_name, source, order) {
    var output='';
    ...
    try {
	    ...
	    //	    var ast = source;	// This tries to make a random expression work
	    var value = myEval( ast, order );
	    startAV(av_name, value,order);
	    return value.join('\n');
        }
    } catch (exception) {
...
//       $('#'+av_name).on("jsav-message", function () {
//         // invoke MathJax to do conversion again
//         MathJax.Hub.Queue(["Typeset", MathJax.Hub]);
//       });
// //      $(".avcontainer").on("jsav-updatecounter", function () {
//       $('#'+av_name).on("jsav-updatecounter", function () {
//         // invoke MathJax to do conversion again
//         MathJax.Hub.Queue(["Typeset", MathJax.Hub]);
//       });
//     }
