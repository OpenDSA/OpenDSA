$(document).ready(function() {
  ...
  av.g.line(140, 130, 250, 130, {"arrow-end": "classic-wide-long", "stroke-width": 2});
  av.label(lambda, {left:180, top: 95});
  av.step();
  ...
  av.umsg("Connect the final state for the NFA with the new finla state by a lambda transition.")
  av.g.line(485, 130, 600, 130, {"arrow-end": "classic-wide-long", "stroke-width": 2});
  av.label(lambda, {left:550, top: 95});
  av.step();
  ...
  av.g.path('M '+ 140 + ',' + 130 + ' Q' + 370 + ',' 
            + 500 + ' ' + 600 + ',' + 135, {"arrow-end": "classic-wide-long", "stroke-width": 2});
  av.label(lambda, {left:370, top: 300});
  av.step();
  ...
  av.g.path('M '+ 600 + ',' + 125 + ' Q' + 370 + ',' 
            + -100 + ' ' + 140 + ',' + 125, {"arrow-end": "classic-wide-long", "stroke-width": 2});
  av.label(lambda, {left:370, top:20});
  fa.disableDragging();
  fa2.disableDragging();
  av.recorded();
