...
$(document).ready(function() {
  ...
  av.umsg("Step 2: Process the symbol 1. The tape head shifts right one cell. The current state remains in q0.");
  g.translateX(30);
  c1.translateX(30);
  c2.translateX(30);
  tape.moveRight();
  ...
  // Slide 4
  av.umsg("Step 3: Process the symbol 0. The tape head shifts right one cell. The current state changes to q1.");
  node[0].unhighlight();
  node[1].highlight();
  p4.hide();
  ...
  // Slide 5
  av.umsg("Step 4: Process the symbol 0. The tape head shifts right one cell. The current state remains in q1.");
  g.translateX(30);
  c2.translateX(30);
  c1.translateX(30);
  tape.moveRight();
