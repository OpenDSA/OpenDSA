...
$(document).ready(function() {
  ...
  av.label("$z^0 = 1$", {left: xLab + 44 * 4, top: yLab});
  av.label("$z^1 = i$", {left: xLab + 44 * 4, top: yLab + 45});
  av.label("$z^2 = -1$", {left: xLab + 44 * 4, top: yLab + 45 * 2});
  av.label("$z^3 = -i$", {left: xLab + 44 * 4, top: yLab + 45 * 3});
