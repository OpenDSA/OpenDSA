...
$(document).ready(function() {
    ...
    var av_name = "TMReplaceCON";
    var xStart = 150;
    var yStart = 0;
    var av = new JSAV(av_name);
  
    // Slide 1
    av.umsg("Here we see a Turing Machine's states and transitions presented in the form of a graph. We also see the tape and the head when beginning to process input string '#II##'.");
    var url = "../../../AV/TJeffrey/TMRep.jff";
