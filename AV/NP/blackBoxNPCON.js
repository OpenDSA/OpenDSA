...
$(document).ready(function() {
  "use strict";
  var av = new JSAV("blackBoxNPCON", {animationMode: "none"});

  var leftx = 300;
  var topy = 5;
  av.g.rect(leftx + 0, topy + 25, 250, 265);

  av.label("Problem A (known NP-complete)", {left: leftx - 100, top: topy - 15});
  ...
  av.label("Problem X",  {left: leftx + 70, top: topy + 132});
  av.label("NP-Complete??",  {left: leftx + 70, top: topy + 147});
