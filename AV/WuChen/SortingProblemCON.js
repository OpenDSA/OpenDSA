...
$(document).ready(function () {
  ...
  var config = ODSA.UTILS.loadConfig({av_name: av_name, json_path: "/AV/WuChen/SortingProblemCON.json"}),
  ...
  arr2.hide();
  arr2 = av.ds.array([0,1,2,3,4,5], {left: leftAlign + 420 + rectWidth, top: topAlign, indexed: false});
