...
$(document).ready(function() {
  "use strict";
  var av = new JSAV("BSTLink", {animationMode: "none"});

	var arrA = av.ds.array([" ", "A", " "], {left: 180});
	
	var topDiff = 50; 
  var arrB = av.ds.array(["/", "B", " "], {left: 40, top: topDiff});
	var arrC = av.ds.array([" ", "C", " "], {left: 320, top: topDiff});
	...
	var arrF = av.ds.array([" ", "F", " "], {left: 410, top: topDiff});
  arrD.css(0, {"background-color": "LightPink"});
  arrD.css(2, {"background-color": "LightPink"});
  arrE.css(2, {"background-color": "LightPink"});
	...
	var arrI = av.ds.array(["/", "I", "/"], {left: 470, top: topDiff});i
