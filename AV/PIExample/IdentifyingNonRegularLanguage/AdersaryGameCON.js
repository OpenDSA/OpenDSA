$(document).ready(function () {
  ...
  av.umsg("As we can see, the adersary game is similar to the pumping lemma proof. But it is used to learn and understand the pumping lemma.");
  av.step();

  av.umsg("As we see, the adersary games are role based game where $\\textbf{WE}$ seek to prove the language is non-regular. $\\textbf{The adversary}$ seeks to stop us.");
  av.step();
  ...
  av.umsg("To connect the adersary game to the pumping lemma prove, we can divide the pumping lemma proof into the adersary game. as follows:");
  av.step();
  ...
  av.umsg("At the end of this page, you will find plenty of adersary games that you can play to practice");
  av.recorded();
