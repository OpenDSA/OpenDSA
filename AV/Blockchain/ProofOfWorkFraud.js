...
$(document).ready(function() {
  ...
  var blocktop = 17;
    ...
    var m1BundleC = av.ds.list({"left": "160px",   "top":"130px", nodegap: 10}).addFirst("C1");
    var m2BundleC = av.ds.list({"left": "260px",   "top":"230px", nodegap: 10}).addFirst("C2");
    var m3BundleC = av.ds.list({"left": "160px",   "top":"230px", nodegap: 10}).addFirst("C3");
