...
$(document).ready(function () {
  ...
  var baseCaseLabel1 = av.label("Region 1",  {"top": topAlign - 25, "left": leftAlign + 400}).css
  ({'font-size': '16px', "text-align": "center"});
  var baseCaseLabel2 =  av.label("Region 2",  {"top": topAlign + 75 , "left": leftAlign + 400}).css
  ({'font-size': '16px', "text-align": "center"});
  av.displayInit();
