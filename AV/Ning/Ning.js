$(document).ready(function() {
    ...
    av.label("In-memory",  {left: left + 65, top: -10}).css({"font-size": "18px"});
    av.label("Table of",  {left: left + 75, top: 10}).css({"font-size": "18px"});
    av.label("Cylinder Keys",  {left: left + 55, top: 30}).css({"font-size": "18px"});
