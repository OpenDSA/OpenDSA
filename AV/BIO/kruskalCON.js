...
$(document).ready(function () {
  ...
  function initGraph() {
    ...
    var b = graph.addNode("A", {"left": 350, "top": -15});
    var c = graph.addNode("A", {"left": 190, "top": 10});
    var d = graph.addNode("A", {"left": 190, "top": 125});
    var e = graph.addNode("A", {"left": 50, "top": 225});
    var f = graph.addNode("A", {"left": 350, "top": 175});
    //Nodes of the MST
    mst.addNode("A", {"left": 25, "top": -15});
    mst.addNode("A", {"left": 325, "top": -15});
    mst.addNode("A", {"left": 145, "top": 10});
    mst.addNode("A", {"left": 145, "top": 125});
    mst.addNode("A", {"left": 0, "top": 225});
    mst.addNode("A", {"left": 325, "top": 175});
