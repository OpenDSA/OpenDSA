$(document).ready(function() {
    ...
    // rectangle A
    av.label("<tt>list1</tt>", {left: xPositionBigRectangles - 30, top: yPositionABig + 10});
    ...
    // rectangle B
    av.label("<tt>list2</tt>", {left: xPositionBigRectangles - 30, top: yPositionABig + 110});
    ...
    // rectangle A
    av.label("<tt>list1</tt>", {left: xPositionBigRectangles2 - 30, top: yPositionABig + 10});
    ...
    // rectangle B
    av.label("<tt>list1</tt>", {left: xPositionBigRectangles2 - 30, top: yPositionABig + 110});
