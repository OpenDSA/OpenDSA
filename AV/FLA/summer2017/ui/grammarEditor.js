...
//export brute force parse from multiple brute force parse page if clicked on the accepted input
function exportBFParse(inputString){
  var productions = JSON.parse(localStorage.getItem("grammars"));
  jsav.umsg('Parsing');
  startParse(m, parseTree);
  $('#bfpbutton').show();
