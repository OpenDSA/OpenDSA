var BFParseController = function(arr, jsav, m, options) {
	this.init(arr, jsav, m, options);
}

var controllerProto = BFParseController.prototype;
...
controllerProto.startParsing = function() {
	...
	var parseHelper = new ParseHelper(this.arr, this.m, this.jsav);
	...
	this.startParse(this.m, parseTree);
	$('#bfpbutton').show();
	/*
