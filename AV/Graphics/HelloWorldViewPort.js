...
(function ($) {
	...
	gl.viewport( left, bottom, wid, ht );
    ...
    function about() {
	alert("The simple HelloWorld program with viewport determined by gl.viewport");
    }
    
    function help() {
	alert("Use the buttons to experiment with the viewport parameters");
    }
    ...
    $('#reset').click(function () { left=0; bottom=0; wid = canvas.width; ht = canvas.height;
 				    } );
