...
$(document).ready(function() {
  ...
  var nodea = graphA.addNode("a", {
    left: 0,
    top: 0
  });
  var nodeb = graphA.addNode("b", {
    left: 0,
    top: 100
  });
  var nodec = graphA.addNode("c", {
    left: 100,
    top: 0
  });
  var noded = graphA.addNode("d", {
    left: 100,
    top: 100
  });
  var nodee = graphA.addNode("e", {
    left: 50,
    top: 50
  });
  ...
  nodea = graphB.addNode("a", {
    left: 0,
    top: 0
  });
  nodeb = graphB.addNode("b", {
    left: 0,
    top: 100
  });
  nodec = graphB.addNode("c", {
    left: 100,
    top: 0
  });
  noded = graphB.addNode("d", {
    left: 100,
    top: 100
  });
  nodee = graphB.addNode("e", {
    left: 50,
    top: 50
  });
