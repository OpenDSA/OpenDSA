...
$(document).ready(function() {
  ...
  var interpret = ODSA.UTILS.loadConfig({
    "av_name": av_name,
    "json_path": "/AV/Graph/GraphDefCON.json"
  }).interpreter;
  ...
  var node0 = graphA.addNode("0", {
    left: 0,
    top: 10
  });
  var node1 = graphA.addNode("1", {
    left: 150,
    top: 0
  });
  var node2 = graphA.addNode("2", {
    left: 75,
    top: 60
  });
  var node3 = graphA.addNode("3", {
    left: 0,
    top: 80
  });
  var node4 = graphA.addNode("4", {
    left: 175,
    top: 65
  });
  var node5 = graphA.addNode("5", {
    left: 200,
    top: 110
  });
  ...
  node0 = graphB.addNode("0", {
    left: 0,
    top: 10
  });
  node1 = graphB.addNode("1", {
    left: 150,
    top: 0
  });
  node2 = graphB.addNode("2", {
    left: 80,
    top: 70
  });
  node3 = graphB.addNode("3", {
    left: 0,
    top: 80
  });
  node4 = graphB.addNode("4", {
    left: 175,
    top: 50
  });
  node5 = graphB.addNode("5", {
    left: 200,
    top: 100
  });
  ...
  node0 = graphC.addNode("0", {
    left: 75,
    top: 0
  });
  node1 = graphC.addNode("1", {
    left: 150,
    top: 50
  });
  node2 = graphC.addNode("2", {
    left: 125,
    top: 110
  });
  node3 = graphC.addNode("3", {
    left: 25,
    top: 110
  });
  node4 = graphC.addNode("4", {
    left: 0,
    top: 50
  });
  ...
  av.label(interpret("av_l8"), {
    top: lTop + lToffset,
    left: 0
  }).show();

  //last graph
  var graphD = av.ds.graph({
    top: gTop + gToffset,
    left: gLeft + gLoffset,
    width: gWidth,
    height: gHeight
  ...
  node0 = graphD.addNode("0", {
    left: 0,
    top: 10
  });
  node1 = graphD.addNode("1", {
    left: 150,
    top: 0
  });
  node2 = graphD.addNode("2", {
    left: 80,
    top: 70
  });
  node3 = graphD.addNode("3", {
    left: 0,
    top: 80
  });
  node4 = graphD.addNode("4", {
    left: 175,
    top: 50
  });
  node5 = graphD.addNode("5", {
    left: 200,
    top: 100
  });
