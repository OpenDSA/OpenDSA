...
$(document).ready(function () {
  ...
  var node0 = graphA.addNode("", {left: gLeft,       top: 0});
  var node1 = graphA.addNode("", {left: gLeft + 100, top: 0});
  var node2 = graphA.addNode("", {left: gLeft + 50,  top: 50});
  var node3 = graphA.addNode("", {left: gLeft,       top: 100});
  var node4 = graphA.addNode("", {left: gLeft + 100, top: 100});

  graphA.addEdge(node0, node3);
  graphA.addEdge(node0, node2);
  graphA.addEdge(node1, node2);
  graphA.addEdge(node4, node1);
  graphA.addEdge(node3, node4);
  ...
  node1 = graphB.addNode(" ", {left: 100, top: 0});
  node2 = graphB.addNode(" ", {left: 50,  top: 50});
  node3 = graphB.addNode(" ", {left: 0,   top: 100});
  node4 = graphB.addNode(" ", {left: 100, top: 100});

  graphB.addEdge(node0, node3);
  graphB.addEdge(node0, node2);
  graphB.addEdge(node1, node2);
  graphB.addEdge(node4, node1);
  graphB.addEdge(node3, node4);
  ...
  node1 = graphC.addNode("2", {left: 100, top: 0});
  node2 = graphC.addNode("4", {left: 50,  top: 50});
  node3 = graphC.addNode("1", {left: 0,   top: 100});
  node4 = graphC.addNode("3", {left: 100, top: 100});

  graphC.addEdge(node0, node3, {weight: 3});
  graphC.addEdge(node0, node2, {weight: 4});
  graphC.addEdge(node1, node2, {weight: 1});
  graphC.addEdge(node4, node1, {weight: 7});
  graphC.addEdge(node3, node4, {weight: 3});
  graphC.addEdge(node2, node3, {weight: 1});
  graphC.layout();
