...
$(document).ready(function() {
  ...
  var a = av.label("Adajceny Matrix: Weights", {
    top: lTop,
    left: 310
  }).show();

  var mat = av.ds.matrix([
    [, 3, , , 4],
    [, , , 3, , ],
    [, , , , 1],
    [, , 7, , , ],
  ...
  var row = av.label(" 0 1 2 3 4", {
    top: gTop,
    left: gLeft + 265
  }).addClass("addSpace");
  var col = av.label(" 0  1  2  3  4", {
    top: gTop + 90,
    left: gLeft + 170
  }).addClass("vertical-text").addClass("addSpace");
  mat.layout();
  ...
  var list1 = av.ds.list({
    top: listTop + listGap * 1,
    left: listLeft
  });
  list1.addFirst("3|3");
  list1.layout();
  ...
  var list2 = av.ds.list({
    top: listTop + listGap * 2,
    left: listLeft
  });
  list2.addFirst("4|1");
  list2.layout();
  ...
  var list4 = av.ds.list({
    top: listTop + listGap * 4,
    left: listLeft
  });
  list4.addFirst("1|1");
  list4.layout();
  ...
  av.label("Adjaceny List: Weights", {
    top: lTop,
    left: 590
  }).show();
});