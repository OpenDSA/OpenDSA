...
(function ($) {
  ...
  var label1 = av.label("8-byte record", {left: 145, top: 0});
  var rect1 = av.g.rect(50, 37, 300, 100);
  var line1 = av.g.line(195, 37, 195, 138, {"stroke-width": "2"});
  var rectlabel1 = av.label("4-byte key", {left: 70, top: 60});
  var rectlabel2 = av.label("4-bytes of data", {left: 210, top: 60});
  ...
  var rect2 = av.g.rect(50, 37, 220, 100);
  var rect3 = av.g.rect(350, 37, 220, 100);
  ...
  var rect4 = av.g.rect(50, 37, 190, 100);
  var rect5 = av.g.rect(380, 37, 190, 100);
  ...
  var rect6 = av.g.rect(50, 37, 190, 100);
  var rect7 = av.g.rect(380, 37, 190, 100);
