...
(function ($) {
  ...
  var arr, count, out;
  var arr_values = [];
    av = new JSAV("RadixSortAnalysisCON");
    ...
    code.css(5,{"background-color":"#99FF66"});	
    av.step();
    ...
    code.css(6,{"background-color":"#00CCFF"});	
    ...
    code.css(8,{"background-color":"#00CCFF"});	
    code.css(6,{"background-color":"white"});
    for (var i = 0; i < 12; i++){
    ...
    arr.unhighlight();
    count.highlight();
    code.css(11,{"background-color":"#00CCFF"});	
    code.css(8,{"background-color":"white"});
    ...
    count.unhighlight();
    code.css(13,{"background-color":"#00CCFF"});	
    code.css(11,{"background-color":"white"});
    arr_values = [];
    ...
    code.css(17,{"background-color":"#00CCFF"});	
    code.css(13,{"background-color":"white"});
    ...
    code.css(5,{"background-color":"#99FF66"});	
    code.css(17,{"background-color":"white"});
