...
(function ($) {
  ...
  function help() {
    myRef = window.open("QSprofHelp.html", 'helpwindow');
  }
  ...
  ************************************************************** */
   ...
   */
  var exercise = av.exercise(modelSolution, initialize, [{css: "background-color"}, {}, {}, {}, {}, {}], {fix: fixState, feedback: "continuous", fixmode: "fix"}); // fixmode: "undo"
    exercise.reset();
