...
+"type of the gate. <br>For e.g. 'A ^' indicates that the gate labelled as 'A' "+
...
"<b>satisfiable</b> if it has a satisfying assignment",{preserve:true});
    ...
    label1= av.label("This circuit is satisfied for the assignment "+
"{ x1='T', x2='F', x3='T' }",{left:10,top:250});  
