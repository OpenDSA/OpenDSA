...
(function ($) {
  ...
  var rt1 = jsav.pointer("rt", bt.root(), {anchor: "right top", top: -10});
  ...
  // SOMETHING WRONG WITH PSEUDO HIGHLIGHTING HERE
...
(function ($) {
  ...
  rt1.hide();
  var root1 = jsav.pointer("root", bt.root(), {anchor: "right top", top: -10});
...
(function ($) {
  ...
  var rt1 = jsav.pointer("rt", bt.root(), {anchor: "left top", top: -10});
...
(function ($) {
  ...
  pseudo.highlight(11);
  var rt2 = jsav.pointer("temp", rt.left().right(), {anchor: "right top", top: -10});
  jsav.step();
