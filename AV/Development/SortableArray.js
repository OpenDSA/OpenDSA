...
(function ($) {
  ...
  var SortableArray = function(jsav, element, options) {
    var defaultOptions = {
      autoresize: false,
      center: true,
      layout: "vertical",
    ...
    this.options.template = '<div class="jsavvalue">' +
    ...
    this.element.addClass("jsavsortablearray");
  ...
  JSAV.utils.extend(SortableArray, JSAV._types.ds.AVArray);
  var sortproto = SortableArray.prototype;

  sortproto._shift = JSAV.anim(function (fromIndex, toIndex) {
  ...
  JSAV.ext.ds.sortable = function(values, options) {
    return new SortableArray(this, values, options);
  };
