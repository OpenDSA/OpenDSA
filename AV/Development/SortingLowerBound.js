...
(function ($) {
  ...
  function runit() {
    ...
    av.label("XYZ", {"top": "3px", "left": "395px"}).css({'font-size': '16px', "text-align": "center"});
    av.g.rect(360, 2, 100, 20).css({"fill":"orange", "opacity":"0.5"});
    av.g.rect(360, 22, 100, 80);
    av.label("XYZ YZX<br>XZY ZXY<br>YXZ ZYX", {"top": "30px", "left": "380px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    av.umsg("The first step in insertion sort is to compare the second element Y with the first element X");
    av.label("$Y < X?$", {"top": "105px", "left": "390px"}).css({'font-size': '12px', "text-align": "center"});
    av.step();
    ...
    av.label("Yes", {"top": "100px", "left": "310px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.rect(275, 140, 50, 20).css({"fill":"orange", "opacity":"0.5"});
    av.label("YXZ", {"top": "141px", "left": "285px"}).css({'font-size': '16px', "text-align": "center"});
    av.g.rect(275, 160, 50, 80);
    av.label("YXZ<br>YZX<br>ZYX", {"top": "165px", "left": "285px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("No", {"top": "100px", "left": "485px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.rect(495, 140, 50, 20).css({"fill":"orange", "opacity":"0.5"});
    av.label("XYZ", {"top": "141px", "left": "505px"}).css({'font-size': '16px', "text-align": "center"});
    av.g.rect(495, 160, 50, 80);
    av.label("XYZ<br>XZY<br>ZXY", {"top": "165px", "left": "505px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("$Z < X?$", {"top": "245px", "left": "275px"}).css({'font-size': '12px', "text-align": "center"});
    av.step();
    ...
    av.label("Yes", {"top": "240px", "left": "225px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.rect(190, 280, 50, 20).css({"fill":"orange", "opacity":"0.5"});
    av.label("YZX", {"top": "281px", "left": "200px"}).css({'font-size': '16px', "text-align": "center"});
    av.g.rect(190, 300, 50, 40);
    av.label("YZX<br>ZYX", {"top": "302px", "left": "200px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("No", {"top": "240px", "left": "350px"}).css({'font-size': '12px', "text-align": "center"});
    var leaf1 = av.g.rect(360, 280, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("YXZ", {"top": "281px", "left": "370px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("$Z < Y?$", {"top": "345px", "left": "190px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.line(190, 340, 130, 380);
    av.g.line(240, 340, 300, 380);
    av.label("Yes", {"top": "340px", "left": "140px"}).css({'font-size': '12px', "text-align": "center"});
    av.label("No", {"top": "340px", "left": "265px"}).css({'font-size': '12px', "text-align": "center"});
    var leaf2 = av.g.rect(105, 380, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("ZYX", {"top": "381px", "left": "115px"}).css({'font-size': '16px', "text-align": "center"});
    var leaf3 = av.g.rect(275, 380, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("YZX", {"top": "381px", "left": "285px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("$Z < Y?$", {"top": "245px", "left": "495px"}).css({'font-size': '12px', "text-align": "center"});
    av.step();
    ...
    av.label("Yes", {"top": "240px", "left": "445px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.rect(410, 280, 50, 20).css({"fill":"orange", "opacity":"0.5"});
    av.label("XZY", {"top": "281px", "left": "420px"}).css({'font-size': '16px', "text-align": "center"});
    av.g.rect(410, 300, 50, 40);
    av.label("XZY<br>ZXY", {"top": "302px", "left": "420px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("No", {"top": "240px", "left": "570px"}).css({'font-size': '12px', "text-align": "center"});
    var leaf4 = av.g.rect(570, 280, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("XYZ", {"top": "281px", "left": "580px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
    ...
    av.label("$Z < X?$", {"top": "345px", "left": "410px"}).css({'font-size': '12px', "text-align": "center"});
    av.g.line(410, 340, 350, 380);
    av.g.line(460, 340, 520, 380);
    av.label("Yes", {"top": "340px", "left": "360px"}).css({'font-size': '12px', "text-align": "center"});
    av.label("No", {"top": "340px", "left": "495px"}).css({'font-size': '12px', "text-align": "center"});
    var leaf5 = av.g.rect(325, 380, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("ZYX", {"top": "381px", "left": "335px"}).css({'font-size': '16px', "text-align": "center"});
    var leaf6 = av.g.rect(495, 380, 50, 20).css({"fill":"green", "opacity":"0.5"});
    av.label("YZX", {"top": "381px", "left": "505px"}).css({'font-size': '16px', "text-align": "center"});
    av.step();
