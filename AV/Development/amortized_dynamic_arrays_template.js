...
var check_add_use, add_element, check_resize_use, resize, dynamic_array_backstep;
...
function dynamic_array() {
	...
	*/
	...
	//add a new element
	add_element = (function(arr, element, c) {
		arr.value(c, element);
		current_index++;
