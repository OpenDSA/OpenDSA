...
$(document).ready(function () {
  ...
  var av = new JSAV(av_name);
    ...
    label1 = av.label("This slideshow presents how to reduce"+
" a Circuit-SAT problem to a SAT problem in polynomial time"
+"<br><br><br>We start by giving some background"
,{top:0});
    av.displayInit();
    av.step();
    label1.hide();
  var board = newCircuit();
    ...
    +" <br>&nbsp;&nbsp;&nbsp;&nbsp;(NOTE: 'If and only if' can be expressed as a conjuntion of clauses.)" 
    ...
    av.umsg("<br><b>Reduction for AND gate with 3 inputs.</b>");
