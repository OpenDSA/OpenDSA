...
(function ($) {
  $(document).ready(function () {
    ...
    ************************************************************** */
    ...
    var used1 = av.g.rect(212, 250, 25, 60).css({"fill": "coral"});
    var used2 = av.g.rect(325, 250, 62, 60).css({"fill": "coral"});
    var used3 = av.g.rect(467, 250, 45, 60).css({"fill": "coral"});
    var used4 = av.g.rect(625, 250, 25, 60).css({"fill": "coral"});
    ...
    function generateIncrements() {
      ...
      incrs[3] = Math.floor(Math.random() * 10) + 3; // Always end in 1
    }
    ...
    var exer = av.exercise(firstFit, initialize, [{css: "background-color"}, {}],
