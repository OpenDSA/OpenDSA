...
" Satisfiability to Hamiltonian Cycle in polynomial time",{top:0}); 
    jsav.displayInit();
...
+"<br><br>3. <b>This graph can be constructed in polynomial time.</b>" 
  ...
  "<b> The path obtained is a Hamiltonian Cycle</b><br><br>",{left:0,top:160});
  jsav.step();
  ...
  "The above assignment satisfies the 3CNF ($x_1$ + $x_2$ + "+ 
            ...
            +"$\\overline{x_2}$ + $x_4$)<br>" , {left:0,top:0});
  jsav.recorded();
});
