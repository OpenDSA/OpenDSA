...
(function ($) {
  ...
  var l2 = av2.g.line(0, 105, 470, 105);
  
  var rect1 = av2.g.rect(20, 30, 60, 75).css({"fill": "lightgray"});
  var rect2 = av2.g.rect(80, 30, 20, 75).css({"fill": "white"});
  var rect3 = av2.g.rect(100, 30, 90, 75).css({"fill": "lightgray"}); 
  var rect4 = av2.g.rect(190, 30, 60, 75).css({"fill": "white"});
  var rect5 = av2.g.rect(250, 30, 70, 75).css({"fill": "lightgray"});
  var rect6 = av2.g.rect(320, 30, 20, 75).css({"fill": "lightgray"});
  var rect7 = av2.g.rect(340, 30, 60, 75).css({"fill": "white"});
  var rect8 = av2.g.rect(400, 30, 30, 75).css({"fill": "lightgray"});
  ...
  var inFragLabel = av2.label("Unused space in allocated block: Internal fragmentation",{left :  20, top:  120});
  var inFragArrow = av2.g.line(315, 125,  330, 107,{'arrow-end': 'classic-wide-long', 'stroke-width' : 2});
