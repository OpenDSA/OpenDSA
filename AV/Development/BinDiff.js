...
$(document).ready(function () {
  var av = new JSAV("BinDiff", {"animationMode": "none"});
  ...
  var alabel = av.label("(a)", {left: btLeft + 30, top: 115}).show;
  var blabel = av.label("(b)", {left: btRight + 35, top: 115}).show;

  // Setup second row of trees
  var btTop = 175;
  var bt3 = av.ds.binarytree({nodegap: 25, top: btTop, left: btLeft});
  bt3.root('A');
  bt3.root().left('B');
  ...
  var clabel = av.label("(c)", {left: btLeft + 30, top: btTop + 105}).show;
