...
$(document).ready(function () {
  var av_name = "LinearRecurrenceSimpleCON";
  ...
  labelSet.push(av.label("0", {"top": topAlign + 8.5 * nodeHeight + 4 * nodeGap , "left": leftAlign + nodeWidth + labelShift * 20}));
  ...
  labelSet.push
  (av.label("|------------------------------ $\\displaystyle\\sum_{i=1}^{n}1$ ------------------------------|", {"top": topAlign + 185 , "left": leftAlign + 190}).addClass("rotated"));
  av.step();
