...
(function () {
  ...
  function getArrayNodes(jsav) {
    ...
    arrays.push(jsav.ds.array([15, 20, ""]));
    arrays.push(jsav.ds.array([33, 45, 48]));
    arrays.push(jsav.ds.array([10, 12, ""]));
    arrays.push(jsav.ds.array([18, "", ""]));
    arrays.push(jsav.ds.array([21, 23, ""]));
    arrays.push(jsav.ds.array([30, 30, ""]));
    arrays.push(jsav.ds.array([38, "", ""]));
    arrays.push(jsav.ds.array([47, "", ""]));
    arrays.push(jsav.ds.array([50, 52, 60]));
    return arrays;
  }
  ...
  function getArrayNodesEdges(jsav, array_nodes, array_node_length, edge_properties) {
    var lines = [];
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[0], array_nodes[1], 0, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[0], array_nodes[2], 0.7, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[1], array_nodes[3], 0, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[1], array_nodes[4], 0.7, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[1], array_nodes[5], 1.3, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[2], array_nodes[6], 0, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[2], array_nodes[7], 0.7, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[2], array_nodes[8], 1.3, array_node_length));
    lines.push(window.BTree.drawEdge(jsav, edge_properties, array_nodes[2], array_nodes[9], 2, array_node_length));
    return lines;
  }
   ...
   * @param top The top value for all nodes.
  ...
  var BTree = {};
  BTree.drawEdge = drawEdge;
  BTree.positionRow = positionRow;
  BTree.getArrayNodes = getArrayNodes;
  BTree.getArrayNodesEdges = getArrayNodesEdges;
  BTree.toggleArrayHiglight = toggleArrayHighlight;
  BTree.toggleEdgeHiglight = toggleEdgeHighlight;
  window.BTree = BTree;
}());