...
$(document).ready(function() {
  ...
  var xStart = 370;
  var yStart = 0;
  av.label("Program", {left: 30 + xStart, top: 0 + yStart});
  ...
  av.label("Output: tokens", {left: 70 + xStart, top: 100 + yStart});
  ...
  av.label("Output: parse tree", {left: 70 + xStart, top: 170 + yStart});
  ...
  av.label("Output:", {left: 35 + xStart, top: 270 + yStart});
  av.label("Assembly Language (C++)", {left: -20 + xStart, top: 290 + yStart});
  av.label("Byte Code (Java)", {left: 10 + xStart, top: 310 + yStart});
