...
$(document).ready(function() {
  ...
  // Frame 1
  av.umsg("We will work through in detail the process of converting the NFA below to the equivalent DFA. To simplify things, we will ignore transitions to the trap state.");
  av.displayInit();
