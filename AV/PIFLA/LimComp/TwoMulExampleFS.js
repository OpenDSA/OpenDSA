$(document).ready(function(){
  ...
  // x-axis
  av.g.line(0*scale, 450*scale, 840*scale, 450*scale, {"stroke-width": 2});

  // y-axis
  av.g.line(410*scale, 30*scale, 410*scale, 460*scale, {"stroke-width": 2});
  ...
  //draw y-axis lines
  for(i = 0; i < 10; i++){
    av.g.line(400*scale, y*scale, 420*scale, y*scale, {"stroke-width": 0.8});
    y += step;
  }

  //draw x-axis lines
  for(i = 0; i < 10; i++){
    av.g.line(x1*scale, 440*scale, x1*scale, 460*scale, {"stroke-width": 0.8});
    av.g.line(x2*scale, 440*scale, x2*scale, 460*scale, {"stroke-width": 0.8});
    x1 -= step;
    x2 += step
  }
  ...
  //x-axis labels
  av.label("-3", {left: 285*scale, top: 440*scale});
  av.label("0",  {left: 405*scale, top: 440*scale});
  av.label("2",  {left: 485*scale, top: 440*scale});
  av.label("5",  {left: 605*scale, top: 440*scale});
  av.label("10", {left: 800*scale, top: 440*scale});

  //y-axis labels
  av.label("1", {left: 380*scale, top: 365*scale});
  av.label("2", {left: 380*scale, top: 325*scale});
  av.label("3", {left: 380*scale, top: 285*scale});
  av.label("9", {left: 380*scale, top: 45*scale});

  //(10, 0) to (-3,9)
  av.g.line(810*scale, 450*scale, 280*scale, 72*scale, {"stroke-width": 3, stroke:"blue"});

  //(-3,9) to (0, 100)
  av.g.line(280*scale, 72*scale, 410*scale, 50*scale, {"stroke-width": 3, stroke:"blue"});

  //(0, 100) to (2, 96)
  av.g.line(410*scale, 50*scale, 490*scale, 58*scale, {"stroke-width": 3, stroke:"blue"});

  //(2, 96) to (5, 75)
  av.g.line(490*scale, 58*scale, 610*scale, 103*scale, {"stroke-width": 3, stroke:"blue"});

  //(5, 75) to (10, 0)
  av.g.line(610*scale, 103*scale, 810*scale, 450*scale, {"stroke-width": 3, stroke:"blue"});

  //point labels and points
  av.label("(-3, $\\sqrt{91}$)", {left: 260*scale, top: 20*scale});
  av.label("(2, $\\sqrt{96}$)", {left: 490*scale, top: 15*scale});
  av.label("(5, $\\sqrt{75}$)", {left: 620*scale, top: 70*scale});

  av.g.circle(280*scale, 72*scale, 4, {fill: 'black'});  // -3,  91
  av.g.circle(410*scale, 50*scale, 4, {fill: 'black'});  //  0, 100
  av.g.circle(490*scale, 58*scale, 4, {fill: 'black'});  //  2,  96
  av.g.circle(610*scale, 103*scale, 4, {fill: 'black'}); //  5,  75
  av.g.circle(810*scale, 450*scale, 4, {fill: 'black'}); // 10,   0
  //formula for y
  // var y = 450 - Math.sqrt(400 - Math.pow((x - 410), 2));

  var poly = "M 5, 225 A 50 50 0 1 1 405 225";
  av.g.path(poly, {"stroke-width": 1, stroke: "gray"});
  av.label("Input to SORTING: the values 5, -3, 2, 0, 10. When converted to points, they fall on a circle as shown.", {left: 0*scale, top:480*scale});
  av.step();
