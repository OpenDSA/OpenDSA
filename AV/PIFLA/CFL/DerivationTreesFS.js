$(document).ready(function () {
  ...
  // Frame 1
  av.umsg("Previously we covered how to derive a string by using sentential forms. Now we will see another, more visual, derivation method.<br/><br/><b>Derivation Trees</b> (also known as <b>parse trees</b>) represent a derivation, but do not show the order in which productions were applied.");
  av.displayInit();
