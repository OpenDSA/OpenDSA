...
(function ($) {
  ...
  newNode.unhighlight();
  l.layout({ updateTop: false });
  // control that top coordinate of nodes should not be recalculated
  l.get(3).highlight();
...
(function ($) {
  ...
  function InsertEmpty(jsavEmp) {
    ...
    this.l = this.jsav.ds.list({
      'nodegap': 30,
      'top': this.topMargin + 40,
      left: this.leftMargin + 17
    });
    this.l.addFirst('null').addFirst('null');
    this.l.layout();
    //Head
    ...
    //Diagonal slash
    this.slash = this.jsav.g.line(this.leftMargin + 125, this.topMargin + 72, this.leftMargin + 135, this.topMargin + 42, {
      'opacity': 0,
      'stroke-width': 1
    });

    //Diagonal slash for new node
    this.newNodeSlash = this.jsav.g.line(this.leftMargin + 198, this.topMargin + 72 + 60, this.leftMargin + 208, this.topMargin + 42 + 60, {
      'opacity': 0,
      'stroke-width': 1
    });

    //Diagonal slash for new tail
    this.newTailSlash = this.jsav.g.line(this.leftMargin + 197, this.topMargin + 72, this.leftMargin + 207, this.topMargin + 42, {
      'opacity': 0,
      'stroke-width': 1
    });
  }
...
(function ($) {
  ...
  var arrowIt = jsav.g.line(leftMargin + 89, topMargin + 70, leftMargin + 129, topMargin + 70, {
      'arrow-end': 'classic-wide-long',
      'opacity': 0,
      'stroke-width': 2
    });
