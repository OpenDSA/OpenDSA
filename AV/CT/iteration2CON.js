...
$(document).ready(function() {
  ...
  av.g.rect(left + 73, top2 + 25, 30, 70, 10).addClass("purplebox").css({opacity: 0.9});
  var arr = av.ds.array(arrValues, {indexed: false, left: leftMargin, top: top + 60, position: "absolute"});
  ...
  it4_midblue1 = av.g.rect(left + 130, top2 + 110, 180, 25, 10).addClass("bluebox");
  it4_midblue2 = av.g.rect(left + 130, top2 + 140, 180, 25, 10).addClass("bluebox");
  it4_midblue3 = av.g.rect(left + 130, top2 + 170, 180, 25, 10).addClass("bluebox");
