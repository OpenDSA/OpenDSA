void sorttime(Comparable[] B) {
  ...
  println("Standard Insertion Sort on Comparable objects for " +
  ...
  println("Standard Insertion Sort on Comparable objects" +
  ...
  println("Shifting Insertion Sort on Comparable objects for " +
          numruns + " runs: Size " + testsize + ", Time: " + totaltime); 
  ...
  println("Shifting Insertion Sort on Comparable objects" +
          " using != instead of < for test, for " + numruns +
          " runs: Size " + testsize + ", Time: " + totaltime);
  ...
  println("Standard Insertion Sort using an int array for " +
          numruns + " runs: Size " + testsize + ", Time: " + totaltime); 
  ...
  for (runs=0; runs<numruns; runs++) {
    for(i=0; i<B.length; i++) Aint[i] = (int)((Integer)B[i]);
    time1 = millis();
    inssortshiftint(Aint);
    time2 = millis();
    checkorder(Aint);
    totaltime += (time2-time1);
  }
  println("Shifting Insertion Sort on int array for " +
          numruns + " runs: Size " + testsize + ", Time: " + totaltime); 
  ...
  println("Standard Insertion Sort on KVPairs for " +
          numruns + " runs: Size " + testsize + ", Time: " + totaltime);
}
...
// Run standard insertion sort using an int array
