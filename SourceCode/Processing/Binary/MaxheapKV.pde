// Max-heap implementation: Key-Value pairs
public class MaxHeap {
  ...
  public MaxHeap(KVPair[] h, int num, int max)
  ...
  public void insert(Object val, int key) {
    if (n >= size) {
      println("Heap is full");
      return;
    }
    int curr = n++;
    Heap[curr] = new KVPair(val, key);  // Start at end of heap
