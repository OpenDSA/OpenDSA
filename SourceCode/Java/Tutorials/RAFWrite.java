...
public class Main {
   ...
   public static void main(String[] args) {
      try {
         ...
         raf.setLength((long)length);//Set the length or size of the file, note that the we do not have to set       
         //length of the file as the write method will "grow" the file with each sequential write
         for(int i=0; i < length; i++){//Run until our file is full
            ...
            System.out.printf("Writing %c at %d\n", chr, raf.getFilePointer());//Ouput our char and where we wrote it
         }
