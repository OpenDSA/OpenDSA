...
public class Timeinssortinline {
    ...
    @Benchmark
    public KVPair[] benchmarkinssortinline() {
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
            .include(Timeinssortinline.class.getSimpleName())
            .build();
